...
from proxmox_selectors import (  # noqa: E402
...
class TestIPAllocation(unittest.TestCase):
    ...
    def test_find_first_available_ip_multi_digit_octets(self) -> None:
        """Regression: string sort misorders 10.0.1.10 before 10.0.1.2"""
        subnet_ips: List[str] = ["10.0.1.10", "10.0.1.2", "10.0.1.3"]
        result = find_first_available_ip([], subnet_ips)
        # Numeric sort: .2 < .3 < .10
        self.assertEqual(result, "10.0.1.2")
...
class TestDeterminism(unittest.TestCase):
    ...
    def test_multiple_runs_same_selection(self) -> None:
        ...
        selected_names = [r["name"] for r in results if r is not None]
